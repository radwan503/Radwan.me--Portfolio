        ...
        <section className="portfolio section" id="portfolio">
            <div className="container">
                ...
                <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active" id="pills-portfoliowork-tab" data-toggle="pill" href="#pills-portfoliowork" role="tab" aria-controls="pills-portfoliowork" aria-selected="true">Web</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" id="pills-otherportfolio-tab" data-toggle="pill" href="#pills-otherportfolio" role="tab" aria-controls="pills-otherportfolio" aria-selected="false">Other</a>
                    </li>
