                ...
                <div className="hero-body">
                    ...
                    <div className="intro-content ml-5">
                        ...
                        <div className="resume">
                            <a href="https://github.com/radwan503/radwan.me/blob/master/src/assets/image/cv.pdf" target="_blank" type="file" className="btn btn-lg btn-green text-white">Get Resume</a>
                        </div>
